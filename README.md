...
[**eslint-plugin-putout**](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout#-@erboladaiorg/quasi-quidem-porro) has a couple rules for 📼**Supertape**:
